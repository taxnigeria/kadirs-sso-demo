        ...
        <div className="bg-emerald-50/70 border border-emerald-200 p-8 sm:p-10 rounded-[28px] text-center space-y-4 animate-in fade-in">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
            ...
            <button
              ...
              className="border border-[var(--gray-200)] bg-white hover:bg-[var(--gray-100)] text-[var(--ink)] px-6 py-2.5 rounded-full text-xs font-semibold flex items-center gap-2 transition-colors cursor-pointer"
            >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  ...
                  <div className="space-y-3 flex-1">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[var(--paper)] border border-[var(--gray-200)] flex items-center justify-center text-[#1AA260] shrink-0">
                    ...
                    <div className="bg-[var(--paper)] border border-[var(--gray-200)] p-4 rounded-2xl text-xs space-y-2">
                      ...
                      <div className="pt-2 border-t border-[var(--gray-200)] text-[var(--ink)] flex flex-wrap items-center gap-1.5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {candidate.matchReasons.map((reason, idx) => (
                          <span
                            key={idx}
                            className="inline-flex items-center gap-1 text-[11px] px-3 py-1 rounded-full bg-white text-[var(--gray-700)] border border-[var(--gray-200)] font-medium"
                          >
                  ...
                  <div className="sm:text-right shrink-0 space-y-3 min-w-[200px]">
                    <div>
                      {candidate.matchTier === 'tier_1_exact_nin' && (
                        <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1 rounded-full bg-emerald-50 text-[#1AA260] border border-emerald-200">
                          <CheckCircle2 className="w-3.5 h-3.5" />
                          Exact Verified Match (NIN)
                        </span>
                      )}
                      {candidate.matchTier === 'tier_2_strong_fuzzy' && (
                        <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1 rounded-full bg-amber-50 text-amber-700 border border-amber-200">
                          <Sparkles className="w-3.5 h-3.5" />
                          Strong Match ({candidate.confidenceScore}%)
                        </span>
                      )}
                      {candidate.matchTier === 'tier_3_conflict' && (
                        <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1 rounded-full bg-rose-50 text-rose-700 border border-rose-200">
                    ...
                    <div className="pt-2">
                      {isLinked ? (
                        <div className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#1AA260] bg-emerald-50 px-4 py-2 rounded-full border border-emerald-200">
                          <Check className="w-4 h-4" />
                          <span>Linked to Citizen Account</span>
                        </div>
                      ) : isDisputed ? (
                        <div className="inline-flex items-center gap-1.5 text-xs font-semibold text-rose-700 bg-rose-50 px-4 py-2 rounded-full border border-rose-200">
                          <XCircle className="w-4 h-4" />
                          <span>Flagged for Review</span>
                        </div>
                      ) : isConflict ? (
                        <div className="space-y-2">
                          <p className="text-[11.5px] text-rose-600 max-w-[32ch] text-left sm:text-right leading-relaxed">
